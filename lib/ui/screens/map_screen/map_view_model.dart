...
import '../../../repositories/stationRepository/station_repository.dart';
import '../../../repositories/stationRepository/station_repositoryMock.dart';
import 'states/station_state.dart';

class MapViewModel extends ChangeNotifier {
  final StationRepository _repo;

  MapViewModel({StationRepository? repo}) : _repo = repo ?? StationRepositoryMock();
  ...
  Future<void> loadStations() async {
    ...
    try {
      ...
      final stations = rawStations.map((s) {
